...
class Game():
 def __init__(self):
  ...
  self.actions = {"left": False,"right": False,"up": False,"down": False,"action1": False,"action2": False,"start": False,"select": False,"deselect": False}
 ...
 def loadAssets(self):
  ...
  self.font = pygame.font.Font(os.path.join(self.fontDir,"alagard.ttf"),20)
